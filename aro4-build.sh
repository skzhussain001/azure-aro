...
function configure_networking(){
    ...
    az role assignment create --scope /subscriptions/$SUBID/resourceGroups/$RESOURCEGROUP/providers/Microsoft.Network/virtualNetworks/$VNET_NAME --assignee ${ROLE_ASSIGNE}  --role "Contributor" -o table > /dev/null
    echo "done"
    exit 0
}
